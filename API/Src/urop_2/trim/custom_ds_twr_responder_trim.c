...
#if defined(CUSTOM_DS_TWR_RESPONDER_TRIM)
...
# define TARGET_XTAL_OFFSET_VALUE_PPM_MIN    (2.5f)
# define TARGET_XTAL_OFFSET_VALUE_PPM_MAX    (3.5f)
...
int custom_ds_twr_responder_trim(void)
{
                            ...
                            {    
                             ...
                             /* Compute time of flight. 32-bit subtractions give correct answers even if clock has wrapped. See NOTE 12 below. */
                              ...
                              //printf("\nPost_Final_cir : %f", cir_phase[3]);
                                ...
                                printf("\ndistance : %f m\n\n", distance);
                                fprintf(test, "%d | %3.2f | %3.2f | %3.2f | %3.2f | %f\n", cnt, cir_phase[0], cir_phase[1], cir_phase[2], cir_phase[3], distance);
                            }
