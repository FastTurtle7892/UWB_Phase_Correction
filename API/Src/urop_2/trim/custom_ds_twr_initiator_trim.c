...
#if defined(CUSTOM_DS_TWR_INITIATOR_TRIM)
 ...
 * @return none
 */
int custom_ds_twr_initiator_trim(void)
{
    ...
    while (1)
    {
        ...
        if (status_reg & SYS_STATUS_RXFCG_BIT_MASK)
        {
            ...
            uCurrentTrim_val = dwt_getxtaltrim();
            float xtalOffset_ppm = ((float)dwt_readclockoffset()) * CLOCK_OFFSET_PPM_TO_RATIO * 1e6;
