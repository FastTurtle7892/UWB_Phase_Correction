...
#if defined(CUSTOM_DS_TWR_RESPONDER_WITH_NO_STS_3)
...
#define POLL_RX_TO_RESP_TX_DLY_UUS 1700
...
#define RESP_TX_TO_FINAL_RX_DLY_UUS 1550
/* Receive final timeout. See NOTE 5 below. */
#define FINAL_RX_TIMEOUT_UUS 290

#define FINAL_RX_POST_FINAL_RX_DLY_UUS 1550
...
int custom_ds_twr_responder_with_no_sts_3(void)
{
    ...
    while (cnt<550)
    {
        ...
        if (status_reg & SYS_STATUS_RXFCG_BIT_MASK)
        {
            ...
            if (memcmp(rx_buffer, rx_poll_msg, ALL_MSG_COMMON_LEN) == 0)
            {
                ...
                resp_tx_time = (POLL_RX_TO_RESP_TX_DLY_UUS * UUS_TO_DWT_TIME) >> 8;
                ...
                uint32_t final_rx_time = (RESP_TX_TO_FINAL_RX_DLY_UUS * UUS_TO_DWT_TIME) >> 8; 
                ...
                if (status_reg & SYS_STATUS_RXFCG_BIT_MASK)
                {
                    ...
                    if (memcmp(rx_buffer, rx_final_msg, ALL_MSG_COMMON_LEN) == 0)
                    {
                        ...
                        post_final_rx_time = (FINAL_RX_POST_FINAL_RX_DLY_UUS * UUS_TO_DWT_TIME) >> 8; 
                        dwt_setdelayedtrxtime(post_final_rx_time);
                        dwt_setrxtimeout(POST_FINAL_TIMEOUT_UUS);
 
                        dwt_rxenable(DWT_START_RX_DLY_RS); 
                        ...
                        if (status_reg & SYS_STATUS_RXFCG_BIT_MASK)
                        {
                            ...
                            {    
                              ...
                              poll_rx_time = (1550 * UUS_TO_DWT_TIME) >> 8; 
                             ...
                             /* Compute time of flight. 32-bit subtractions give correct answers even if clock has wrapped. See NOTE 12 below. */
                              ...
                              printf("\n%f | %f | %f", cir_phase[0] + cir_phase[1], cir_phase[2] - cir_phase[3], cir_phase[0] + cir_phase[1] - cir_phase[2] + cir_phase[3]);
                              //fprintf(test, "%3.2f | %3.2f | %3.2f | 3.2%f\n", cir_phase[0], cir_phase[1], cir_phase[2], cir_phase[3]);
                              //fprintf(test, "%3.2f\n", cir_phase[0] + cir_phase[1] - cir_phase[2] + cir_phase[3]);
