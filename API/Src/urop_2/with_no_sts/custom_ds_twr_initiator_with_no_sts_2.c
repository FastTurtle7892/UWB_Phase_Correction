...
#if defined(CUSTOM_DS_TWR_INITIATOR_WITH_NO_STS_2)
...
int custom_ds_twr_initiator_with_no_sts_2(void)
{
            ...
            if (memcmp(rx_buffer, rx_resp_msg, ALL_MSG_COMMON_LEN) == 0)
            {
                ...
                if (ret == DWT_SUCCESS)
                {
                    ...
                    if (ret == DWT_SUCCESS)
                    {
                      ...
                      uint32_t poll_tx_time = (post_final_tx_ts + (1300 * UUS_TO_DWT_TIME)) >> 8;
