...
#if defined(CUSTOM_DS_TWR_RESPONDER_WITH_NO_STS_5)
...
#define POLL_RX_TO_RESP_TX_DLY_UUS 1400
...
#define RESP_TX_TO_FINAL_RX_DLY_UUS 1250
/* Receive final timeout. See NOTE 5 below. */
#define FINAL_RX_TIMEOUT_UUS 298

#define FINAL_RX_POST_FINAL_RX_DLY_UUS 1250
...
int custom_ds_twr_responder_with_no_sts_5(void)
{
                    ...
                    if (memcmp(rx_buffer, rx_final_msg, ALL_MSG_COMMON_LEN) == 0)
                    {
                        ...
                        if (status_reg & SYS_STATUS_RXFCG_BIT_MASK)
                        {
                            ...
                            {    
                              ...
                              poll_rx_time = (post_final_rx_ts + (1250 * UUS_TO_DWT_TIME)) >> 8;
