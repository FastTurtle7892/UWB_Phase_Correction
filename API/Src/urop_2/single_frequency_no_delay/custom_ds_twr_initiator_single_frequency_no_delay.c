...
#if defined(CUSTOM_DS_TWR_INITIATOR_SINGLE_FREQUENCY_NO_DELAY)
...
#define POLL_TX_TO_RESP_RX_DLY_UUS 1350

#define RESP_RX_TO_FINAL_TX_DLY_UUS 1500

#define RESP_RX_TIMEOUT_UUS 281

#define FINAL_TX_POST_FINAL_TX_DLY_UUS 1500

#define POST_FINAL_TX_POLL_TX_DLY_UUS 1500
...
int custom_ds_twr_initiator_single_frequency_no_delay(void)
{
                ...
                if (memcmp(rx_buffer, rx_resp_msg, ALL_MSG_COMMON_LEN) == 0)
                {
                    ...
                    if (ret == DWT_SUCCESS)
                    {
                        ...
                        if (ret == DWT_SUCCESS)
                        {
                            ...
                            uint32_t poll_tx_time = (post_final_tx_ts + (POST_FINAL_TX_POLL_TX_DLY_UUS * UUS_TO_DWT_TIME)) >> 8;
