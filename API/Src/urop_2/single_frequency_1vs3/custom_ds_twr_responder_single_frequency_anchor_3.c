...
#if defined(CUSTOM_DS_TWR_RESPONDER_SINGLE_FREQUENCY_ANCHOR_3)
...
int custom_ds_twr_responder_single_frequency_anchor_3(void)
{
                          ...
                          if (memcmp(rx_buffer, rx_final_msg, ALL_MSG_COMMON_LEN) == 0)
                          {
                              ...
                              if (status_reg & SYS_STATUS_RXFCG_BIT_MASK)
                              {
                                  ...
                                  {    
                                    ...
                                    poll_rx_time = (post_final_rx_ts + (14700 * UUS_TO_DWT_TIME)) >> 8;
