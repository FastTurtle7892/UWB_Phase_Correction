...
#if defined(CUSTOM_DS_TWR_INITIATOR_CHANNEL_SWITCHING)
...
#define POLL_TX_TO_RESP_RX_DLY_UUS 1170
...
#define RESP_RX_TO_FINAL_TX_DLY_UUS 1379
/* Receive response timeout. See NOTE 5 below. */
#define RESP_RX_TIMEOUT_UUS 282

#define FINAL_TX_POST_FINAL_TX_DLY_UUS 1370
...
int custom_ds_twr_initiator_channel_switching(void)
{
