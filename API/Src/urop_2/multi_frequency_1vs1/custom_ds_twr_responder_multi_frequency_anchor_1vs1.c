...
#if defined(CUSTOM_DS_TWR_RESPONDER_MULTI_FREQUENCY_ANCHOR_1VS1)
...
int custom_ds_twr_responder_multi_frequency_anchor_1vs1(void)
{
    ...
    while (1)
    {
        ...
        if (status_reg & SYS_STATUS_RXFCG_BIT_MASK)
        {
         ...
         if(distance_ch5 != 0 && distance_ch9 != 0 && !state)
         {
            ...
            //printf("\n%f|%f", new_distance_ch5, new_distance_ch9);
            //printf("\n%f", new_dist);
            //printf("\n%f", final_dist);
