...
#if defined(CUSTOM_DS_TWR_INITIATOR_MULTI_FREQUENCY_1VS1)
...
static bool now_ch5 = true;
static bool now_ch9 = false;
...
int custom_ds_twr_initiator_multi_frequency_1vs1(void)
{
